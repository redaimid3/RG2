...
module.exports = async function(db, game, player, context, limits) {
    ...
    if (game.gamesData[context.peerId].convData.isActive == true && game.gamesData[context.peerId].convData.gamemode == 'dreamcatcher' && context.messagePayload && context.messagePayload.action == 'dreamcatcher' && context.messagePayload.bet == 'X5' && context.messagePayload.type == 'conversation') {
        ...
        for (i in game.gamesData) {
            if (game.gamesData[i].convGame.bets[context.senderId] && game.gamesData[i].convGame.bets[context.senderId].x5 && game.gamesData[i].convData.isActive == true && game.gamesData[i].convData.gamemode == 'dreamcatcher') {
                currentStavka += Math.floor(game.gamesData[i].convGame.bets[context.senderId].x5)
            }
        }
        ...
        if (!game.gamesData[context.peerId].convGame.bets[context.senderId].x5) {
            game.gamesData[context.peerId].convGame.bets[context.senderId].x5 = 0
        }
        ...
        game.gamesData[context.peerId].convGame.bets[context.senderId].x5 += Math.floor(_coin)
