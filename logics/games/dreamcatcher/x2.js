...
module.exports = async function(db, game, player, context, limits) {
    ...
    if (game.gamesData[context.peerId].convData.isActive == true && game.gamesData[context.peerId].convData.gamemode == 'dreamcatcher' && context.messagePayload && context.messagePayload.action == 'dreamcatcher' && context.messagePayload.bet == 'X2' && context.messagePayload.type == 'conversation') {
        ...
        for (i in game.gamesData) {
            if (game.gamesData[i].convGame.bets[context.senderId] && game.gamesData[i].convGame.bets[context.senderId].x2 && game.gamesData[i].convData.isActive == true && game.gamesData[i].convData.gamemode == 'dreamcatcher') {
                currentStavka += Math.floor(game.gamesData[i].convGame.bets[context.senderId].x2)
            }
        }
        ...
        if (!game.gamesData[context.peerId].convGame.bets[context.senderId].x2) {
            game.gamesData[context.peerId].convGame.bets[context.senderId].x2 = 0
        }
        ...
        game.gamesData[context.peerId].convGame.bets[context.senderId].x2 += Math.floor(_coin)
