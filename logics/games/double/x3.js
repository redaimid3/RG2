...
module.exports = async function (db, game, player, context, limits) {
    ...
    if (game.gamesData[context.peerId].convData.isActive == true && game.gamesData[context.peerId].convData.gamemode == 'double' && context.messagePayload && context.messagePayload.action == 'double' && context.messagePayload.bet == 'X3' && context.messagePayload.type == 'conversation') {
        ...
        for (i in game.gamesData) {
            if (game.gamesData[i].convGame.bets[context.senderId] && game.gamesData[i].convGame.bets[context.senderId].x3 && game.gamesData[i].convData.isActive == true && game.gamesData[i].convData.gamemode == 'double') {
                currentStavka += Math.floor(game.gamesData[i].convGame.bets[context.senderId].x3)
            }
        }
        ...
        if (!game.gamesData[context.peerId].convGame.bets[context.senderId].x3) {
            game.gamesData[context.peerId].convGame.bets[context.senderId].x3 = 0
        }
        ...
        game.gamesData[context.peerId].convGame.bets[context.senderId].x3 += Math.floor(_coin)
